...
Tags: address, cell phone, contact, email, facebook, fax, flickr, g+, google plus, google+, icons, imdb, instagram, linkedin, phone, pinterest, position, responsive, skype, slideshare, snapchat, social media, soundcloud, tumblr, twitter, vimeo, xing, yelp, youtube
...
The plugin is available in English, German (Deutsch) and Polish (Polski).
...
* **"Perfect 5 star plugin"** in [WordPress.org Reviews](https://wordpress.org/support/topic/perfect-5-star-plugin/) by maartensurf on December 13, 2017
* **"This plugin is the only one in the whole repository that really provides what I want."** in [WordPress.org Support](https://wordpress.org/support/topic/remove-link-phone-and-email-link-on-desktop/) by stepheniryna on July 14, 2017
* **"the BEST customer service I have received in 2016!"** in [WordPress.org Support](https://wordpress.org/support/topic/hide-the-email-address-but-still-it-responsive/#post-8606116) by chrissavid33 on December 31, 2016
* **"100% recommended. Saved my time"** in [WordPress.org Reviews](https://wordpress.org/support/topic/i-love-this-plugin-193) by ramarao on August 20, 2016
* **"Exactly what I needed"** in [WordPress.org Reviews](https://wordpress.org/support/topic/exactly-what-i-needed-340) by wineisallforme on May 23, 2016
...
* **"Absolutely fantastic. Was exactly what I was looking for and looks brilliant on my website."** in [WordPress.org Reviews](https://wordpress.org/support/topic/does-exactly-what-youd-expect) by tydem00 on April 15, 2015
...
5. **Cell phone number**, automatically **linked** to open an available phone application, can be displayed with a **text of your choice**
6. **E-Mail address**, automatically **linked** to open an available mail client, can be displayed with a **text of your choice**
7. any further content you wish by using the filter hook `speed-contact-bar-data` (as documented in section &quot;Add and re-order list entries by using hooks&quot; below)
...
16. Yelp
17. Youtube
18. any further content you wish by using the filter hook `speed-contact-bar-icons` (as documented in section &quot;Add and re-order list entries by using hooks&quot; below)
...
7. **Background color opacity** of the contact bar, i.e. its grade of transparency
8. **Text color**
9. **Link color**
10. **Lightness of icons**: You can select between **dark** or **bright** icons
11. **Content alignment** within the bar
12. **Font size** of the texts and links
13. **Icon size**
14. **Headline visibility**: switch the headline on or off
15. **Headline text**
16. **Headline HTML tag**
17. **Headline URL** to make the headline a link
18. **Shadow under or above the bar** for a chic 3D effect
19. **Link target** of all links to open a contact link in the same window or in a new window
20. **Show contact data on small displays** instead of showing icons only
21. any further style you wish by using the filter hook `speed-contact-bar-style`
...
Read the section &quot;Add and re-order list entries by using hooks&quot; about how to use the plugin's hooks.
...
If you are a developer please read the section &quot;Add and re-order list entries by using hooks&quot;. You will find a documentation about the hooks of the Speed Contact Bar. That way you can easily insert your own content into the bar.
...
= 6.0 =
Refactored buffering, tested with WP 4.9.4

= 5.1 =
Added options for fax icon and background color opacity, small fixes, tested with WP 4.9.1

= 5.0 =
Added option to exclude links from opening in new windows, tested with WordPress 4.8.2

= 4.9.3 =
Removed antispambot(), added 'Requires PHP' info in readme.txt

= 4.9.2 =
Increased maximum font size, email sanitization, tested with Wordpress 4.8.1

= 4.9.1 =
Fixed malformed output of the email address

= 4.9 =
Revised sanitizations and translations, tested with WordPress 4.8

= 4.8 =
Text options for phone and cell phone, updated Instagram icon, fixed layout in some themes, WP 4.7.3

= 4.7 =
Added link text option for the email link

= 4.6.1 =
Added link target for the postal address
...
= 4.5.1 =
Removed conversion of '+' to '00' in phone numbers, tested with WP 4.6.1

= 4.5 =
Added Snapchat option

= 4.4 =
Revised uninstall function, tested with WP 4.6

= 4.3 =
Added Skype option, tested with WordPress 4.5.3

= 4.2.4 =
Added polish translation, revised plugin activation message function, tested with WP 4.5
